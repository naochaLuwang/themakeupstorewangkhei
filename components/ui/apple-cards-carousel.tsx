    ...
    <>
      ...
      >
        ...
        <div className="text-center">
          ...
          <motion.p
            layoutId={layout ? `title-${card.title}` : undefined}
            className="text-black text-base md:text-xl font-semibold mt-2 mb-10"
          >
            {card.title}
          </motion.p>
          ...
          <Link href="https://mybillbook.in/store/the_make_up_store"
            ...
            className="w-fit h-fit bg-black text-white text-base font-medium tracking-wider py-2 px-4 shadow-sm rounded-full "
          >
            BUY NOW
          </Link>
        </div>
